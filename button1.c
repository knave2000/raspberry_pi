...
// при обнаружении нажатой кнопки на порту P1_05.
// Светодиод подключён к порту P1_03
// Компиляция командой: gcc -o button1 button1.c -lrt -lbcm2835
// Запуск: sudo ./button1
...
#define PIN_IN RPI_V2_GPIO_P1_05    // определяем порт для чтения
...
int main()
{
    ...
    bcm2835_gpio_fsel(PIN_IN, BCM2835_GPIO_FSEL_INPT);  // устанавливаем порт P1_05 на ввод
